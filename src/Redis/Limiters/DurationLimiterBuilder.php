...
namespace Fast\Redis\Limiters;

use Fast\Support\InteractsWithTime;
use Fast\Contracts\Redis\LimiterTimeoutException;
...
class DurationLimiterBuilder
{
     ...
     *
     * @var \Fast\Redis\Connections\Connection
     */
    public $connection;
     ...
     *
     * @param  \Fast\Redis\Connections\Connection  $connection
     * @param  string  $name
     * @return void
     */
     ...
     * @return mixed
     *
     * @throws \Fast\Contracts\Redis\LimiterTimeoutException
     */
