...
class Str
{
     ...
     * @return string
     */
    public static function kebab($value, $encoding = null)
    {
        return static::snake($value, '-', $encoding);
    }
     ...
     * @return string
     */
    public static function limit($value, $limit = 100, $end = '...', $encoding = null)
    {
        if (null == $encoding) {
            $encoding = mb_internal_encoding();
        }
     ...
     * @return string
     */
    public static function words($value, $words = 100, $end = '...', $encoding = null)
    {
        ...
        if (! isset($matches[0]) || static::length($value, $encoding) === static::length($matches[0], $encoding)) {
            return $value;
        }
    ...
    public static function snake($value, $delimiter = '_', $encoding = null)
    {
        ...
        if (! ctype_lower($result)) {
            ...
            $result = static::lower(preg_replace('/(.)(?=[A-Z])/u', '$1'.$delimiter, $result), $encoding);
        }
