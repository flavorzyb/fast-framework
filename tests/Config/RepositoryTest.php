...
namespace Fast\Tests\Config;

use PHPUnit\Framework\TestCase;
use Fast\Config\Repository;

class RepositoryTest extends TestCase
{
    /**
     * @var \Fast\Config\Repository
     */
    ...
    public function testHasIsTrue()
    {
        ...
        $this->assertTrue($this->repository->offsetExists('foo'));
    }
    ...
    public function testGet()
    {
        ...
        $this->assertSame('bar', $this->repository->offsetGet('foo'));
    }
    ...
    public function testSet()
    {
        ...
        $this->repository->offsetSet('key2', 'value');
        $this->assertSame('value', $this->repository->get('key2'));
    }
