...
use Fast\Contracts\Support\Jsonable;
use Fast\Contracts\Support\Arrayable;
...
class CollectionTest extends TestCase
{
    ...
    {
        $item1 = m::mock('Fast\Contracts\Support\Arrayable');
        $item1->shouldReceive('toArray')->once()->andReturn('foo.array');
        $item2 = m::mock('Fast\Contracts\Support\Arrayable');
    ...
    public function testWhere()
    {
        ...
        $c = new Collection([['v' => 1], ['v' => new \Fast\Support\HtmlString('hello')]]);
        $this->assertEquals(
            [['v' => new \Fast\Support\HtmlString('hello')]],
        ...
        $this->assertEquals(
            [['v' => 'hello']],
            $c->where('v', new \Fast\Support\HtmlString('hello'))->values()->all()
        );
    }
