...
class StrTest extends TestCase
{
    ...
    public function testStringCanBeLimitedByWords()
    {
        ...
        $this->assertEquals('Taylor...', Str::words('Taylor Otwell', 1, '...', Str::ENCODING_UTF_8));
    ...
    public function testStringTitle()
    {
        ...
        $this->assertEquals('Jefferson Costella', Str::title('jefFErson coSTella', Str::ENCODING_UTF_8));
    }
    ...
    public function testKebab()
    {
        ...
        $this->assertEquals('laravel-php-framework', Str::kebab('LaravelPhpFramework', Str::ENCODING_UTF_8));
    }

    public function testLower()
    {
        $this->assertEquals('foo bar baz', Str::lower('FOO BAR BAZ'));
        $this->assertEquals('foo bar baz', Str::lower('FOO BAR BAZ', Str::ENCODING_UTF_8));
        $this->assertEquals('foo bar baz', Str::lower('fOo Bar bAz'));
    }
    ...
    public function testUpper()
    {
        ...
        $this->assertEquals('FOO BAR BAZ', Str::upper('foO bAr BaZ', Str::ENCODING_UTF_8));
    }
    ...
    public function testLimit()
    {
        ...
        $this->assertEquals('这是一!!!', Str::limit('这是一段中文', 6, '!!!', Str::ENCODING_UTF_8));
        $this->assertEquals('这是一段中文', Str::limit('这是一段中文', 100));
    }

    public function testLength()
    {
        $this->assertEquals(11, Str::length('foo bar baz'));
        $this->assertEquals(6, Str::length('这是一段中文', 'UTF-8'));
    }
    ...
    public function testSnake()
    {
        ...
        $this->assertEquals('laravel_php_framework', Str::snake('LaravelPhpFramework','_', Str::ENCODING_UTF_8));
    ...
    public function testSubStr()
    {
        ...
        $this->assertEquals('Ё', Str::subStr('БГДЖИЛЁ', -1, null, Str::ENCODING_UTF_8));
    ...
    public function testUcfirst()
    {
        ...
        $this->assertEquals('Laravel', Str::ucfirst('laravel', Str::ENCODING_UTF_8));
